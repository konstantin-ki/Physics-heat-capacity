 ...
 * хранилища объектов "soft" SPI шины.
 * Задачи класса динамически создавать и добавлять в контейнер новый объект SPI шины. Шины SPI
 * в текущей реализации создаются только в soft варианте. При создании возвращается объект типа SPI шина.
